               ...
               <% if (userEmail != null) { %>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 m-0">
                        ...
                        <a href="logout.jsp" class="dropdown-item"><i class="fa fa-sign-out-alt"></i> Logout</a>
                    </div>
                </div>
            <% } else { %>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-4 wow fadeIn" data-wow-delay="0.3s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <span>skilllink360@gmail.com</span>
                                </div>
                            </div>
                            <div class="col-md-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <span>+923326181428</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3239.039104195945!2d68.82889277485877!3d24.65079997806682!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x394dd9944bb49e19%3A0x3e1d90dbfedf0fa9!2sSindh%20University%20Laar%20Campus%20Badin!5e1!3m2!1sen!2s!4v1743909176937!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="index.jsp">JobSkill</a>, All Right Reserved. 
